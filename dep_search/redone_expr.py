...
def get_or_groups(node):
    ...
    pass#print 'Checking split queries!'
    for sb in subtrees:
        pass#print sb.to_unicode()
    pass#print
    pass#print 'That was it!'
...
def turn_into_caseless(node):
     ...
     try:
         ...
         if isinstance(node.setnode1, SetNode_Token) and node.setnode1.proplabel == '' and node.token_restriction != '_':
             ...
             pass#print 'new_kid', new_kid.to_unicode()
...
def get_possible_subtrees(node):
    ...
    if not isinstance(node, SetNode_Or):
        ...
        for p in kid_products:
            ...
            #pass#print
            #pass#print n_node.to_unicode()
            n_node = copy.copy(node)
            #pass#print [px.to_unicode() for px in p]
            n_node.set_kids(p)

            #pass#print 'Set kids ', p
            #pass#print 'Kids set ', n_node.get_kid_nodes()

            nodes_to_return.append(n_node)
    else:
           #OR node
           #pass#print 'ORN'
           #pass#print kids[0].to_unicode()
           #pass#print kids[1].to_unicode()
           #pass#print '!ORN'
...
if __name__=="__main__":
    ...
    for expression in args.expression:
        ...
        for g in get_or_groups(ebin):
            pass#print [t.to_unicode() for t in g]
        pass#print 'END!'
