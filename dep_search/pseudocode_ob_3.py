...
class SetManager():
    ...
    def __init__(self, nodes, node_dict, tag_list=[], val_dict={}):
        ...
        #pass#print 'set_and_array_labels', set_and_array_labels
...
def get_cinit_function(set_manager, max_len=2048):
    ...
    lines.append('        self.tree = new Tree()')
...
def visualize_sets(set_manager, node_dict):
    ...
    print
    pass#print 'Node Sets'

    for key in set_manager.node_needs.keys():

        print
        pass#print node_dict[key].to_unicode()
        pass#print 'Sets needed from the db:'
        for ikey in set_manager.node_needs[key]['db_sets_label'].keys():
            pass
            pass#print ikey, set_manager.node_needs[key]['db_sets_label'][ikey]
        pass#print 'Arrays needed from the db:'
        for ikey in set_manager.node_needs[key]['db_arrays_label'].keys():
            pass
            pass#print ikey, set_manager.node_needs[key]['db_arrays_label'][ikey]
        pass#print 'All_tokens needed:'
        for ikey in set_manager.node_needs[key]['all_tokens_label']:
            pass#print ikey
            pass
        pass#print 'Output_sets needed:'
        if set_manager.node_needs[key]['own_output']:
            pass#print set_manager.node_needs[key]['own_output_set']
...
def visualize(node, node_dict):
    ...
    for lev in levels:
        pass#print 
        pass#print 'Level:', lev
        print

        for node in lev_nodes[lev]:

            pass#print node.to_unicode()
            pass#print 'level', node.level
            pass#print 'compulsory', not node.negs_above
            pass#print 'node_id', node.node_id
            print
...
def main():
    ...
    for expression in args.expression:
        ...
        pass#print >> sys.stderr, nodes.to_unicode()
...
def generate_and_write_search_code_from_expression(expression, f, json_filename='', db=None, case=False):
    ...
    import sys
    pass#print >> sys.stderr, expression
    pass#print >> sys.stderr, 'db', db
    pass#print >> sys.stderr, 'case', case
    ...
    pass#print >> sys.stderr, 'ps3orgs', nodes.to_unicode()
    code_lines = generate_search_code(nodes, tag_list=tag_list, val_dict=val_dict)
